...
#ifndef SHA256_FINAL_LE
	#define SHA256_FINAL_LE		1
#endif
...
#if (SHA256_FINAL_LE)
	// Since this implementation uses little endian byte ordering and micro-ecc also,
	// do not reverse the bytes when copying the final state to the output hash.
	for (i = 0; i < 4; ++i) {
